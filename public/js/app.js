...
app.use(Object(function webpackMissingModule() { var e = new Error("Cannot find module './store/store'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
app.use(Object(function webpackMissingModule() { var e = new Error("Cannot find module './router/router'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
app.component('app-component', Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/App'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
app.mount('#app');
